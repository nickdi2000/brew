...
#glass {
	...
	-webkit-animation: glass 5s infinite;
...
#poignet {
	...
	right: 0;
		...
		border-left: none;
		transform: rotate(-20deg);
	-webkit-animation: poignet 5s infinite;
animation: poignet 5s infinite;
}
...
#beer {
	...
	&::before {
		...
		-webkit-animation: beer 5s infinite;
...
#mousse_1 {
	...
	&::before {
		...
		border-radius: 50%;
		position: absolute;
		-webkit-animation: mousse 5s infinite;
animation: mousse 5s infinite;
	}
